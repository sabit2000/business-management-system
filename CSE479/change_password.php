...
<body>
  ...
  <section class="custom-form-section" id="signin">
    <div class="profile-container" style="height: 50dvh;">
      <!-- 1st row -->
      <div class="profile-row justify-content-center">
        <div class="col-lg-9">
          <div class="c_title text-center">
            <h1 class="c_h1 yellow form-title">Change Password</h1>
          </div>
        </div>
      </div>
      <!-- 2nd row -->
            ...
            <form method="POST" action="updateprofile.php" enctype="multipart/form-data">
              <div class="row g-3 justify-content-center">
                ...
                <div class="col-lg-8 col-md-8">
                  <input type="text" class="form-control c_email" placeholder="Old Password" name="name" required
                    value="" />
                </div>
                <div class="col-lg-8 col-md-8">
                  <input type="text" class="form-control c_email" placeholder="New Password" name="username" required
                    value="" />
                </div>
                <div class="col-lg-8 col-md-8">
                  <input type="text" class="form-control c_email" placeholder="Confirm Password" name="email" required
                    value="" />
                </div>
              </div>
