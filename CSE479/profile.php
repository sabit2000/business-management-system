...
if ($result->num_rows > 0) {
  ...
  $email = $row['email'];
  $profilePhotoPath = $row['profilePicturePath']; // Assuming the column name is 'profilePicturePath'
}
...
<body>
      ...
      <div class="profile-row justify-content-center">
        <div class="col-lg-9">
          <div class="c_title text-center">
            ...
            <p class="c_p ash">Check and Edit your Information</p>
          </div>
        </div>
      </div>
            ...
            <form method="POST" action="updateprofile.php" enctype="multipart/form-data">
              <div class="row g-3 justify-content-center">
                ...
                <div class="col-lg-8 col-md-8 d-flex justify-content-center align-items-center">
                  ...
                  <div id="image-preview-wrapper">
                    <label for="profile-picture" id="image-preview-label">
                      <img id="image-preview" src="<?php echo $profilePhotoPath; ?>" alt="Profile Photo" />
                ...
                <div class="col-lg-8 col-md-8">
                  <input type="text" class="form-control c_email" placeholder="Fullname" name="name" required
                    value="<?php echo $fullName; ?>" />
                </div>
                <!-- Username Input -->
                <div class="col-lg-8 col-md-8">
                  <input type="text" class="form-control c_email" placeholder="Username" name="username" required
                    value="<?php echo $username; ?>" />
                </div>
                <!-- Email Input -->
                <div class="col-lg-8 col-md-8">
                  <input type="email" class="form-control c_email" placeholder="Email" name="email" required
                    value="<?php echo $email; ?>" />
                </div>
                <div class="col-lg-7 col-md-7 container-fluid">
                  <div class="button-container">
                    <a href="logout.php" class="profile-btn c_button alt-button" style="margin-top: 5rem">Logout</a>
                    <a href="password_page.php" class="profile-btn c_button alt-button" style="margin-top: 5rem">Change
                      Password</a>
  ...
  <script>
    window.addEventListener('load', function () {
      var profilePhotoUrl = "<?php echo $profilePhotoPath; ?>";
