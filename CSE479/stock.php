      ...
      <div class="add-product-row-1 justify-content-center">
        <div class="col-lg-9">
          <div class="add-product-c_title text-center">
            <h1 class="c_h1 yellow form-title">Stock</h1>
          </div>
        </div>
      </div>
            ...
            <form action="save_stock.php" method="POST" enctype="multipart/form-data">
              <div class="add-product-row g-3 justify-content-center">
                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="truck_name" required
                    placeholder="Truck Name" />
                </div>
                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="truck_number" required
                    placeholder="Truck Number" />
                </div>

                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="driver_name" required placeholder="Driver Name" />
                </div>
                <div class="col-lg-9 col-md-9">
                ...
                <div class="col-lg-9 col-md-9">
                  ...
                  <br />
                  <select class="form-select" id="category" name="product_type" required>
                ...
                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="client" required
                    placeholder="Client" />
                </div>
                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="quantity" required
                    placeholder="Quantity (Tons)" />
                </div>

                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="warehouse_number" required
