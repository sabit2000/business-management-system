      ...
      <div class="add-product-row-1 justify-content-center">
        <div class="col-lg-9">
          <div class="add-product-c_title text-center">
            <h1 class="c_h1 yellow form-title">Contact Us</h1>
          </div>
        </div>
      </div>
            ...
            <form action="contact_save.php" method="POST" enctype="multipart/form-data">
              <div class="add-product-row g-3 justify-content-center">
                ...
                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="customer_name" required placeholder="Name" />
                </div>

                <div class="col-lg-9 col-md-9">
                  <input type="text" class="form-control" id="title" name="email" required placeholder="Email" />
                </div>

                <!-- Article Content -->
                <div class="col-lg-9 col-md-9">
                  <textarea class="form-control" id="content" name="message" rows="5" required
