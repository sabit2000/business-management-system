      ...
      <div class="add-product-row-1 justify-content-center">
        <div class="col-lg-9">
          <div class="add-product-c_title text-center">
            <h1 class="c_h1 yellow form-title">Add Product</h1>
          </div>
        </div>
      </div>
          ...
          <div class="add-product-c_form">
            <form action="save_product.php" method="POST" enctype="multipart/form-data">
              <div class="add-product-row g-3 justify-content-center">
                ...
                <div class="col-lg-9 col-md-9">
                  <textarea class="form-control" id="content" name="description" rows="5" required
                    placeholder="Product Description"></textarea>
                </div>


                <div class="col-lg-9 col-md-9">
                  <input type="file" id="photo" name="photo" accept="image/*" required placeholder="photo">
                </div>
              ...
              <div class="col-lg-2 col-md-2 button">
                <button type="submit" class="btn c_button" style="margin-top: 5rem;">Submit</button>
              </div>
            </form>
          </div>
        </div>
